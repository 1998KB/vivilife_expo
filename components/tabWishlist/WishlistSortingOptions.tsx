    ...
    <View className="absolute z-10 bg-gray-50 border border-gray-200 rounded-3xl p-1 mt-2">
      <View className=" flex flex-row items-center justify-center ">
        ...
        <TouchableOpacity
          ...
          className={`py-2 px-4 rounded-2xl ${wishlistSortOption === "date" ? "bg-white border border-gray-200" : "bg-gray-50"}`}
        >
          <Text
            className={` ${wishlistSortOption === "date" ? "text-black" : "text-gray-500"}`}
          >
            Date
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          className={`py-2 px-4 rounded-2xl  ${wishlistSortOption === "distance" ? "bg-white border border-gray-200" : "bg-gray-50"}`}
        >
          <Text
            className={` ${wishlistSortOption === "distance" ? "text-black" : "text-gray-500"}`}
          >
            Distance
          </Text>
        </TouchableOpacity>
